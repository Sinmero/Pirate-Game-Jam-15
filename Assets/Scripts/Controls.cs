...
public class Controls : MonoBehaviour
{
    ...
    KeyCode.LeftShift, KeyCode.R, KeyCode.Escape, KeyCode.B, KeyCode.Alpha1, KeyCode.Alpha2, KeyCode.Alpha3, KeyCode.Space, KeyCode.I, KeyCode.Q, KeyCode.F);
    ...
    KeyCode.Space, KeyCode.R, KeyCode.Escape, KeyCode.B, KeyCode.Alpha1, KeyCode.Alpha2, KeyCode.Alpha3, KeyCode.Space, KeyCode.I, KeyCode.Q, KeyCode.F);
    ...
    KeyCode.None, KeyCode.None, KeyCode.None, KeyCode.None, KeyCode.None, KeyCode.None, KeyCode.None, KeyCode.None, KeyCode.None, KeyCode.None, KeyCode.None);
...
public struct controlKeys
{
    ...
    KeyCode returnToCheckpoint, KeyCode settingsMenu, KeyCode buildMenu, KeyCode key1, KeyCode key2, KeyCode key3, KeyCode confirm, KeyCode inventory, KeyCode interactSecondary, KeyCode interactHold)
    {
        _jump = jump;
        _left = left;
        _right = right;
